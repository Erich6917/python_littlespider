...
class mainAll(object):
    ...
    def scrapy_start(self):
        ...
        for each in url_list:
            init_url, url = each.split('\t')[0], each.split('\t')[1]
            try:
                # url = 'http://tingshen.court.gov.cn/live/5202044'
                # url = 'http://player.videoincloud.com/vod/3243925?src=gkw&cc=1'
                print 'telnet', url
                ...
                if not source_target:
                    ...
                    rt_msg = '{}\t{}\t{}\n'.format(init_url, url, source_target)
    ...
    def get_source_url(self):
        ...
        with open('url_source.txt', 'r+') as file_url:
    ...
    def init(self):
        self.file_url = open('source_mp4.txt', 'a+')  # URL读取文件
        self.file_error = open('error_mp4.txt', 'a+')  # 日志错误记录
        self.file_log = None  # 日志常规记录
