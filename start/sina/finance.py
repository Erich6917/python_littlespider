...
def finance_parse_start(url_list):
    ...
    p_blog = r'http://blog.sina.com.cn/s/.*'  # sina blog

    p_finance = r'http://finance.sina.com.cn/.*'  # sina finace normal type
    ...
    print '=============开始匹配=============== 初始请求条数', len(url_list)
    ...
    for url in url_list:
        ...
        try:
            ...
            print '解析失败：', url, ':', e
            continue
    print '=============匹配结束===============', '本次采集数量：', len(rdicts), '已存在记录', num_exist
